...
<s:iterator value="coinDetails" status="stat">
       <tr>
       ...
       <td><s:property value="openid"/></td>
		...
		<s:form action="listcoin.action" method="post" enctype ="multipart/form-data" onsubmit="return checkPage()" >
<div>
	<table>
	<br/>
		<tr>
