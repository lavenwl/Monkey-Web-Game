...
<html>
	...
	<h1>任务列表</h1>
		...
		<s:else>
			<a href="missionlist.action?page=${page-1 }">上一页</a>
		</s:else>
	当前【
	...
	<s:else>
			<a href="missionlist.action?page=${page+1 }">下一页</a>
	</s:else>
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	&nbsp&nbsp&nbsp
	<a href="geitwojspmission">添加</a>
	<table border=1>
		<tr>
			<th>id</th>
	...
	-->
	<s:iterator value="gamemissions" status="statta">
		<tr>
			<td>${id }</td>
			...
			<td>
			<a href="projectmission!load.action?id=${id }">更新</a>
			</td>
		</tr>
	</s:iterator>
	</table>
