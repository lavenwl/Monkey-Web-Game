...
public class CompassApi {
	 ...
	 *            应用的密钥
	 */
	public CompassApi(String appid, String appkey) {
		this.appid = appid;
		this.appkey = appkey;
	 ...
	 * @return 返回服务器响应内容
	 */
	public String api(String scriptName, HashMap<String, String> params,
...
//		params.put("sig", sig);
		...
		// 统计上报
		SnsStat.statReport(startTime, serverName, params, method, protocol, rc);
	 ...
	 * @return 返回服务器响应内容
	 */
	public String apiUploadFile(String scriptName,
			HashMap<String, String> params, FilePart fp, String protocol)
		...
		// 发送请求
		String resp = SnsNetwork.postRequestWithFile(url, params, cookies, fp,
				protocol);
