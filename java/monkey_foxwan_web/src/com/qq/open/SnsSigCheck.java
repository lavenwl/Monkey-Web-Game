...
public class SnsSigCheck {
	 ...
	 * 生成签名
	 * 
	 * @param method HTTP请求方法 "get" / "post" @param url_path CGI名字, eg:
	 * /v3/user/get_info @param params URL请求参数 @param secret 密钥 @return 签名值
	 ...
	 * 
	 * @param method HTTP请求方法 "get" / "post" @param url_path CGI名字, eg:
	 * /v3/user/get_info @param params URL请求参数 @return 签名所需源串
	 */
