...
//			.getGameItem();
	...
	private List<GameBbuffDetail> gamebbuffs;
	//injection
	...
	public String execute(){
		...
		try {
			...
			gamebbuffs=gameBbuffService.findAllBbuff(param);
			List<GameBbuffDetail> alltie=gameBbuffService.getGameBbuff();
	...
	public List<GameBbuffDetail> getGamebbuffs() {
		return gamebbuffs;
	}

	public void setGamebbuffs(List<GameBbuffDetail> gamebbuffs) {
		this.gamebbuffs = gamebbuffs;
	}
