...
//			.getGameItem();
	...
	private List<GameBuffDetail> gamebuffs;
	//injection
	...
	public String execute(){
		...
		try {
			...
			gamebuffs=gameBuffService.findAllBuff(param);
			List<GameBuffDetail> alltie=gameBuffService.getGameBuff();
	...
	public List<GameBuffDetail> getGamebuffs() {
		return gamebuffs;
	}

	public void setGamebuffs(List<GameBuffDetail> gamebuffs) {
		this.gamebuffs = gamebuffs;
	}
