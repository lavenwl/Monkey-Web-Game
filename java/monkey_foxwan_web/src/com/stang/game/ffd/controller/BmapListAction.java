...
//			.getGameItem();
	...
	private List<GameBmapDetail> gamebmaps;
	//injection
	...
	public String execute(){
		...
		try {
			...
			gamebmaps=gameBmapService.findAllBmap(param);
			List<GameBmapDetail> alltie=gameBmapService.getGameBmap();
	...
	public List<GameBmapDetail> getGamebmaps() {
		return gamebmaps;
	}

	public void setGamebmaps(List<GameBmapDetail> gamebmaps) {
		this.gamebmaps = gamebmaps;
	}
