...
import com.stang.game.ffd.common.PageList;
import com.stang.game.ffd.common.PageProperty;
import com.stang.game.ffd.common.PageUtil;
...
public class BaseServiceImpl<T> implements IBaseService<T> {
	...
	/**
	 * @method getCount 
	 * @param pp {PageProperty} 封装分页条件信息的类对象，供数据库查询
	 * @return {Resopse}
	 * @description 获取记录总数
	 */
	...
	/**
	 * @method insert 
	 * @param model {T} 提供插入的数据，封装在实体类对象
	 * @return {Resopse}
	 * @description 插入记录
	 */
	...
	/**
	 * @method update 
	 * @param model {T} 提供更新的数据，封装在实体类对象
	 * @return {Resopse}
	 * @description 更新数据
	 */
