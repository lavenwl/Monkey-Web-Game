...
<html>
	...
	<h1>任务列表</h1>
		...
		<s:else>
			<a href="maplist.action?page=${page-1 }">上一页</a>
		</s:else>
	当前【
	...
	<s:else>
			<a href="maplist.action?page=${page+1 }">下一页</a>
	</s:else>
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	&nbsp&nbsp&nbsp
	<a href="geitwojspmap">添加</a>
	<table border=1>
		<tr>
			<th>编号</th>
	...
	-->
	<s:iterator value="gamemaps" status="statta">
		<tr>
			<td>${id }</td>
			...
			<td>
			<s:property value="getyin"/>
			</td>
			<td>
			<a href="projectmap!load.action?id=${id }">更新</a>
			</td>
		</tr>
	</s:iterator>
	</table>
