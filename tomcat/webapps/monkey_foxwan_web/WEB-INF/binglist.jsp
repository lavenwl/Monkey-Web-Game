...
<html>
	...
	<h1>任务列表</h1>
		...
		<s:else>
			<a href="binglist.action?page=${page-1 }">上一页</a>
		</s:else>
	当前【
	...
	<s:else>
			<a href="binglist.action?page=${page+1 }">下一页</a>
	</s:else>
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	&nbsp&nbsp&nbsp
	<a href="geitwojspbing">添加</a>
	<table border=1>
		<tr>
			<th>id</th>
	...
	-->
	<s:iterator value="gamebings" status="statta">
		<tr>
			<td>${id }</td>
			...
			<td>
			<a href="projectbing!load.action?id=${id }">更新</a>
			</td>
		</tr>
	</s:iterator>
	</table>
